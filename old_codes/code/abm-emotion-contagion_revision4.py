...
##############
folderpath = r"C:\Users\SEscottoRo\OneDrive - Toyota Industries Group North America\Documents\My stuff\other\Masters\523\Simulation\same\Leader L"  # in the quotations, put the name of the folder in which you want the results to be saved to  
...
def run_simulation(seed=0, run_id=0, save_folder=None):
    ...
    # if save_folder:
    #     run_folder = os.path.join(save_folder, f"Results {run_id + 1}")
...
folderpath = r"C:\Users\SEscottoRo\OneDrive - Toyota Industries Group North America\Documents\My stuff\other\Masters\523\Simulation\same\Leader L\Intervention"
...
#df_interventions.to_csv(os.path.join(folderpath, "Intervention_Timesteps_Summary_High.csv"), index=False)
